...
--  Add created_at to user table if missing
...
--    ⚠️  IMPORTANT: Generate a new hash BEFORE running this script.
--       Use PHP: echo password_hash('YourStrongPassword', PASSWORD_BCRYPT, ['cost' => 12]);
